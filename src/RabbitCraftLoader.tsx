...
export function RabbitCraftLoader({
  ...
  const contourClipId = `rabbit-contour-${instanceId}`;
    ...
    >
      ...
      >
        <defs>
          ...
          <clipPath id={contourClipId} clipPathUnits="userSpaceOnUse">
            <path d={RABBIT_CONTOUR} />
          </clipPath>
